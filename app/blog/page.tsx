...
const posts = [
  ...
  {
    slug: 'ahorro-previsional-voluntario-apv',
    title: 'APV en Chile: qué es y cómo ahorrar para jubilarte mejor',
    excerpt: 'El Ahorro Previsional Voluntario (APV) te permite mejorar tu pensión y obtener beneficios tributarios. Te explicamos los regímenes A y B y cuánto conviene ahorrar.',
    date: '2026-04-05',
    readTime: '6 min',
    category: 'Previsión',
    categoryColor: 'text-indigo-400 bg-indigo-400/10',
  ...
  {
    slug: 'impuesto-segunda-categoria-chile',
    title: 'Impuesto de Segunda Categoría en Chile: tramos y cálculo 2026',
    excerpt: 'El IUSC es el impuesto que se descuenta mensualmente de tu sueldo. Conoce los tramos, cómo se calcula y en qué casos puedes recuperar dinero en la operación renta.',
    date: '2026-03-28',
    readTime: '5 min',
    category: 'Impuestos',
    categoryColor: 'text-amber-400 bg-amber-400/10',
  ...
  {
    slug: 'uf-en-arriendo-chile',
    title: 'UF en contratos de arriendo: cómo funciona y qué debes saber',
    excerpt: 'Muchos contratos de arriendo en Chile se pactan en UF. Aprende cómo calcular el reajuste anual, qué dice la ley y cómo protegerte como arrendatario o arrendador.',
    date: '2026-03-15',
    readTime: '5 min',
    category: 'Vivienda',
    categoryColor: 'text-emerald-400 bg-emerald-400/10',
  ...
  {
    slug: 'finanzas-personales-chile-2026',
    title: 'Finanzas personales en Chile 2026: guía para empezar',
    excerpt: 'Presupuesto, ahorro, deudas e inversión: los cuatro pilares de las finanzas personales explicados con contexto chileno. Ideal para quienes parten desde cero.',
    date: '2026-03-01',
    readTime: '8 min',
    category: 'Finanzas',
    categoryColor: 'text-blue-400 bg-blue-400/10',
